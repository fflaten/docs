...
```powershell
New-PesterContainer -Path <String[]> [-Data <IDictionary[]>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
New-PesterContainer -ScriptBlock <ScriptBlock[]> [-Data <IDictionary[]>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
