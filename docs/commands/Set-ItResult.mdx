...
```powershell
Set-ItResult [-Inconclusive] [-Because <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Pending

```powershell
Set-ItResult [-Pending] [-Because <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Skipped

```powershell
Set-ItResult [-Skipped] [-Because <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
