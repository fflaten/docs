...
Invoke-Pester [[-Path] <String[]>] [-ExcludePath <String[]>] [-TagFilter <String[]>]
 ...
 [-Container <ContainerInfo[]>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
Invoke-Pester [[-Path] <String[]>] [-TagFilter <String[]>] [-ExcludeTagFilter <String[]>]
 ...
 [-PesterOption <Object>] [-Show <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Advanced

```powershell
Invoke-Pester [-Configuration <PesterConfiguration>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
(Deprecated v4)
Makes Skipped tests to Failed tests.
