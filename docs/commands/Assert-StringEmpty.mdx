---
id: Assert-StringEmpty
title: Assert-StringEmpty
description: Help page for the PowerShell Pester "Assert-StringEmpty" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-StringEmpty [[-Actual] <Object>] [-Because <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
