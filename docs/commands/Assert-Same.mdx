...
id: Assert-Same
title: Assert-Same
description: Help page for the PowerShell Pester "Assert-Same" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-Same [[-Actual] <Object>] [-Expected] <Object> [-Because <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
