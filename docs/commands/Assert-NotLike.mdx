---
id: Assert-NotLike
title: Assert-NotLike
description: Help page for the PowerShell Pester "Assert-NotLike" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-NotLike [[-Actual] <Object>] [-Expected] <String> [-CaseSensitive] [-Because <String>]
