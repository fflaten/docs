...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Be] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [<CommonParameters>]
```

### BeExactly

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeExactly] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeGreaterThan] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeLessOrEqual] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeIn] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeLessThan] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeGreaterOrEqual] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeLike] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeLikeExactly] [<CommonParameters>]
```

### BeNullOrEmpty

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-BeNullOrEmpty] [<CommonParameters>]
```

### BeOfType

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-BeOfType]
 [-ExpectedType <Object>] [<CommonParameters>]
```

### BeTrue

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-BeTrue]
 [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-BeFalse]
 [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-Contain] [<CommonParameters>]
```

### Exist

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-Exist]
 [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-FileContentMatch] [-ExpectedContent <Object>] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchExactly] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchMultiline] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchMultilineExactly] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-HaveCount] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-HaveParameter] [-ParameterName <Object>] [-Type <Object>] [-DefaultValue <Object>] [-Mandatory]
 [-InParameterSet <Object>] [-HasArgumentCompleter] [-Alias <Object>] [<CommonParameters>]
```

### Match

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-Match]
 [-RegularExpression <Object>] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-RegularExpression <Object>] [-MatchExactly] [<CommonParameters>]
```

### Throw

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-Throw]
 [-ExpectedMessage <Object>] [-ErrorId <Object>] [-ExceptionType <Object>] [-PassThru] [<CommonParameters>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>]
 [-InvokeVerifiable] [<CommonParameters>]
```

### Invoke

```powershell
Should [[-ActualValue] <Object>] [-ProgressAction <ActionPreference>] [-Not] [-Because <Object>] [-Invoke]
 [-CommandName <Object>] [-Times <Object>] [-ParameterFilter <Object>] [-ExclusiveFilter <Object>]
 [-ModuleName <Object>] [-Scope <Object>] [-Exactly] [-CallerSessionState <Object>] [<CommonParameters>]
```
