...
id: Assert-True
title: Assert-True
description: Help page for the PowerShell Pester "Assert-True" command
keywords:
  - PowerShell
  - Pester
  - Help
...
It does not convert input values to boolean, and will fail for any value is not $true.

## SYNTAX

```powershell
Assert-True [[-Actual] <Object>] [[-Because] <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
