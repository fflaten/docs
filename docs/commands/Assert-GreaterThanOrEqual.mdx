---
id: Assert-GreaterThanOrEqual
title: Assert-GreaterThanOrEqual
description: Help page for the PowerShell Pester "Assert-GreaterThanOrEqual" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-GreaterThanOrEqual [[-Actual] <Object>] [-Expected] <Object> [-Because <String>]
...
[https://pester.dev/docs/commands/Should-BeGreaterThanOrEqual](https://pester.dev/docs/commands/Should-BeGreaterThanOrEqual)
