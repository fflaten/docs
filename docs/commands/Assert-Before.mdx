...
id: Assert-Before
title: Assert-Before
description: Help page for the PowerShell Pester "Assert-Before" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-Before [[-Actual] <Object>] [-Now] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Fluent

```powershell
Assert-Before [[-Actual] <Object>] [[-Time] <Object>] [-Ago] [-FromNow] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Assert-Before [[-Actual] <Object>] [[-Expected] <DateTime>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
