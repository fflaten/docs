---
id: Assert-StringNotEqual
title: Assert-StringNotEqual
description: Help page for the PowerShell Pester "Assert-StringNotEqual" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-StringNotEqual [[-Actual] <Object>] [[-Expected] <String>] [-Because <String>] [-CaseSensitive]
 [-IgnoreWhitespace] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
