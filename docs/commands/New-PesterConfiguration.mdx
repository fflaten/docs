...
```powershell
New-PesterConfiguration [[-Hashtable] <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
This increases performance of breakpoint based CodeCoverage.
  Default value: $true
