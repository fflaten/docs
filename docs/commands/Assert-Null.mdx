...
id: Assert-Null
title: Assert-Null
description: Help page for the PowerShell Pester "Assert-Null" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-Null [[-Actual] <Object>] [-Because <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
