...
id: Assert-Type
title: Assert-Type
description: Help page for the PowerShell Pester "Assert-Type" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-Type [[-Actual] <Object>] [-Expected] <Type> [-Because <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
