---
id: Assert-GreaterThan
title: Assert-GreaterThan
description: Help page for the PowerShell Pester "Assert-GreaterThan" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-GreaterThan [[-Actual] <Object>] [-Expected] <Object> [-Because <String>]
...
[https://pester.dev/docs/commands/Should-BeGreaterThan](https://pester.dev/docs/commands/Should-BeGreaterThan)
