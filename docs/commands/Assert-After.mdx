...
```powershell
Assert-After [[-Actual] <Object>] [-Now] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Fluent

```powershell
Assert-After [[-Actual] <Object>] [[-Time] <Object>] [-Ago] [-FromNow] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Assert-After [[-Actual] <Object>] [[-Expected] <DateTime>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
