---
id: Assert-LessThan
title: Assert-LessThan
description: Help page for the PowerShell Pester "Assert-LessThan" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-LessThan [[-Actual] <Object>] [-Expected] <Object> [-Because <String>]
