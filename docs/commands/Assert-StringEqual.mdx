---
id: Assert-StringEqual
title: Assert-StringEqual
description: Help page for the PowerShell Pester "Assert-StringEqual" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Assert-StringEqual [[-Actual] <Object>] [-Expected] <String> [-Because <String>] [-CaseSensitive]
