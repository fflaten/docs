...
*This configuration documentation is generated from Pester 5.5.0.*
...
| UseBreakpoints | EXPERIMENTAL: When false, use Profiler based tracer to do CodeCoverage instead of using breakpoints. | `bool` | `$true` |
| SingleHitBreakpoints | Remove breakpoint when it is hit. | `bool` | `$true` |
